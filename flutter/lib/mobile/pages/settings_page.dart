...
SettingsThemeData _settingsTheme(BuildContext context) {
  final colors = MyTheme.color(context);
  return SettingsThemeData(
    settingsListBackground: colors.panelBackgroundSecondary,
    settingsSectionBackground: colors.panelBackground,
    tileHighlightColor: colors.hover,
    ...
    trailingTextColor: colors.weakText,
    tileDescriptionTextColor: colors.weakText,
    leadingIconsColor: MyTheme.accent,
  );
}
...
class __DisplayPageState extends State<_DisplayPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: colors.panelBackgroundSecondary,
      appBar: AppBar(
        leading: IconButton(
          ...
          builder: (context, snapshot) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: colors.inputBorder ?? MyTheme.border),
              ),
              child: trustedDevicesTable(trustedDevices, selectedDevices),
            );
          }),
    );
  }
