...
const String kDashboardDevMode =
    String.fromEnvironment('RUSTDESK_DEV_DASHBOARD_MODE');
const String kDashboardDevShellRoute = '/dev/agent-dashboard';

bool get kDashboardDevShellEnabled => kDashboardDevMode.isNotEmpty;

AgentDashboardDevMode get kResolvedDashboardDevMode =>
    kDashboardDevMode.toLowerCase() == 'floating'
    ...
    return RefreshWrapper(builder: (context) {
      return MultiProvider(
        ...
        child: GetMaterialApp(
          ...
          routes: {
            kDashboardDevShellRoute: (_) => AgentDashboardDevShell(
                  mode: kResolvedDashboardDevMode,
                ),
          },
          home: kDashboardDevShellEnabled
              ? AgentDashboardDevShell(
                  mode: kResolvedDashboardDevMode,
                )
              : isDesktop
