...
class PlatformFFI {
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      try {
        if (isAndroid) {
          // Android 12+ rejects writes to custom top-level public directories.
          // Use the public Download directory so Rust side paths like
          // `<home>/RustDesk/ScreenRecord` resolve under an allowed location.
          try {
            _homeDir = await ExternalPath.getExternalStoragePublicDirectory(
