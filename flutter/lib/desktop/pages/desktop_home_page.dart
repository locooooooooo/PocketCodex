  ...
  Widget buildLeftPane(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      ...
      child: Container(
        ...
        color: colors.panelBackgroundSecondary,
        child: Stack(
          children: [
            Column(
              children: [
                ...
                child: Align(
                  ...
                  child: InkWell(
                    child: Obx(
                      () => Icon(
                        Icons.settings,
                        color: _editHover.value ? textColor : colors.weakText,
                        size: 22,
                      ),
                    ),
                    onTap: () => {
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          translate("ID"),
                          style:
                              TextStyle(fontSize: 14, color: colors.weakText),
                        ).marginOnly(top: 5),
      ...
      child: Tooltip(
        ...
        child: Obx(
          () => CircleAvatar(
            radius: 15,
            backgroundColor:
                hover.value ? colors.hover : colors.panelBackgroundSecondary,
            child: Icon(
              Icons.more_vert_outlined,
              size: 20,
              color: hover.value ? textColor : colors.weakText,
            ),
          ),
        ),
      ),
              ...
              child: Column(
                ...
                children: [
                  AutoSizeText(
                    ...
                    style: TextStyle(fontSize: 14, color: colors.weakText),
                    maxLines: 1,
                  ),
                  Row(
                    children: [
        ...
        Container(
          ...
          child: Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color:
                        MyTheme.color(context).inputBorder ?? MyTheme.border),
              ),
                                  ...
                                  children: [
                                    FixedWidthButton(
                                      ...
                                      textColor: Theme.of(context)
                                          ...
                                          .titleLarge
                                          ?.color,
                                      borderColor: MyTheme.color(context)
