...
class _ToolbarTheme {
  ...
  static Color inactiveColor = const Color(0xFF7B879B);
  static Color hoverInactiveColor = const Color(0xFF5D6A7E);
...
class _MonitorMenu extends StatelessWidget {
  ...
  Widget buildMonitorMenu(BuildContext context) {
    ...
    final monitorsIcon = globalMonitorsWidget(
        context, width, Colors.white, _ToolbarTheme.hoverInactiveColor);
  ...
  List<Widget> buildMonitorList(BuildContext context, bool isMulti) {
    ...
    final theme = MyTheme.color(context);
    ...
    buildMonitorButton(int i) => Obx(() {
          ...
          if (isAllMonitors) {
            monitorsIcon = globalMonitorsWidget(
                context, width, Colors.white, _ToolbarTheme.blueColor);
          }
                      ...
                      children: [
                        SvgPicture.asset(
                          ...
                          colorFilter: ColorFilter.mode(
                              theme.panelBackground ?? Colors.white,
                              BlendMode.srcIn),
                        ),
      ...
      for (var i = 0; i < pi.displays.length; i++) {
        ...
        children.add(Positioned(
          ...
          child: Container(
            decoration: BoxDecoration(
              border: Border.all(
                color: _ToolbarTheme.hoverInactiveColor,
                width: 1.0,
              ),
