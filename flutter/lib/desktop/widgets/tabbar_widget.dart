...
class TabbarTheme extends ThemeExtension<TabbarTheme> {
  ...
  static const light = TabbarTheme(
      ...
      unSelectedTabIconColor: Color(0xFFA8B6CC),
      selectedTextColor: Colors.black,
      unSelectedTextColor: Color(0xFF6E7687),
      selectedIconColor: Color(0xFF1E2530),
      unSelectedIconColor: Color(0xFF6E7687),
      dividerColor: Color(0xFFE3E8F2),
  ...
  static const dark = TabbarTheme(
      selectedTabIconColor: MyTheme.accent,
      unSelectedTabIconColor: Color(0xFF3E536E),
      selectedTextColor: Colors.white,
      unSelectedTextColor: Color(0xFF9AA4B6),
      selectedIconColor: Color(0xFFE8EEF9),
      unSelectedIconColor: Color(0xFF9AA4B6),
      dividerColor: Color(0xFF2B3648),
      hoverColor: Color(0xFF202733),
      closeHoverColor: Color(0xFF10141B),
      selectedTabBackgroundColor: Color(0x262C8CFF));
