...
class ColorThemeExtension extends ThemeExtension<ColorThemeExtension> {
  const ColorThemeExtension({
    ...
    required this.panelBackgroundSecondary,
  ...
  final Color? panelBackgroundSecondary;
  ...
  static final light = ColorThemeExtension(
    ...
    panelBackgroundSecondary: Color(0xFFF5F7FB),
    inputBackground: Color(0xFFF6F7FB),
    inputBorder: Color(0xFFE2E7F0),
    secondaryButtonBackground: Color(0xFFF2F5FB),
    secondaryButtonBorder: Color(0xFFD9E2F2),
    secondaryButtonHover: Color(0xFFE8EEF8),
    weakText: Color(0xFF6E7687),
    hover: Color(0xFFF0F4FA),
    selectedBackground: Color(0xFFEAF2FF),
  ...
  static final dark = ColorThemeExtension(
    ...
    panelBackground: Color(0xFF181C24),
    panelBackgroundSecondary: Color(0xFF10141B),
    inputBackground: Color(0xFF141922),
    inputBorder: Color(0xFF293243),
    secondaryButtonBackground: Color(0xFF202733),
    secondaryButtonBorder: Color(0xFF2B3648),
    secondaryButtonHover: Color(0xFF273140),
    weakText: Color(0xFF9AA4B6),
    hover: Color(0xFF202733),
    selectedBackground: Color(0x262C8CFF),
    appBarBackground: Color(0xFF10141B),
    bottomNavBackground: Color(0xFF10141B),
  );
  ...
  ThemeExtension<ColorThemeExtension> copyWith({
    ...
    Color? panelBackgroundSecondary,
    ...
    return ColorThemeExtension(
      ...
      panelBackgroundSecondary:
          panelBackgroundSecondary ?? this.panelBackgroundSecondary,
  ...
  ThemeExtension<ColorThemeExtension> lerp(
    ...
    return ColorThemeExtension(
      ...
      panelBackgroundSecondary: Color.lerp(
          panelBackgroundSecondary, other.panelBackgroundSecondary, t),
...
class MyTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    inputDecorationTheme: isDesktop
        ? InputDecorationTheme(
            ...
            filled: true,
            isDense: true,
            hintStyle: TextStyle(color: Color(0xFF8B95A7)),
    ...
    textTheme: const TextTheme(
        ...
        bodySmall:
            TextStyle(fontSize: 12, color: Color(0xFF5A6474), height: 1.35),
        bodyMedium:
            TextStyle(fontSize: 14, color: Colors.black87, height: 1.35),
        labelLarge: TextStyle(fontSize: 16.0, color: MyTheme.accent80)),
    cardColor: Colors.white,
    hintColor: Color(0xFF8B95A7),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        foregroundColor: Colors.black87,
        side: BorderSide(color: Color(0xFFD9E2F2)),
        elevation: 0,
        padding: EdgeInsets.symmetric(horizontal: 18, vertical: 14),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(14.0),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    hoverColor: Color(0xFF202733),
    scaffoldBackgroundColor: Color(0xFF10141B),
    dialogBackgroundColor: Color(0xFF181C24),
    canvasColor: Color(0xFF181C24),
    appBarTheme: AppBarTheme(
      shadowColor: Colors.transparent,
    ...
    cardTheme: CardTheme(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(20),
        side: BorderSide(color: Color(0xFF2B3648)),
      ),
    ),
    ...
    inputDecorationTheme: (isDesktop || isWebDesktop)
        ? InputDecorationTheme(
            ...
            filled: true,
            isDense: true,
            hintStyle: TextStyle(color: Color(0xFF8893A5)),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide: BorderSide(color: Color(0xFF293243)),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide: BorderSide(color: accent, width: 1.2),
    ...
    textTheme: const TextTheme(
      ...
      bodySmall:
          TextStyle(fontSize: 12, height: 1.35, color: Color(0xFF9AA4B6)),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(color: Color(0xFF2B3648), width: 1),
        disabledForegroundColor: Colors.white70,
        foregroundColor: Colors.white70,
        elevation: 0,
        padding: EdgeInsets.symmetric(horizontal: 18, vertical: 14),
...
void msgBox(SessionID sessionId, String type, String title, String text,
  ...
  if (type == 'agent-confirm') {
    final token = RegExp(r'Token:\s*(\S+)').firstMatch(text)?.group(1) ?? '';
    final requestId =
        RegExp(r'Request:\s*(\S+)').firstMatch(text)?.group(1) ?? '';
    buttons = [
      dialogButton(
        'Cancel',
        onPressed: () {
          dialogManager.dismissAll();
          final cancelTarget = requestId.isNotEmpty ? requestId : token;
          if (cancelTarget.isNotEmpty) {
            bind.sessionSendChat(
                sessionId: sessionId, text: '/agent-cancel $cancelTarget');
          }
        },
        isOutline: true,
      ),
      dialogButton(
        ...
        onPressed: token.isEmpty
            ...
            : () {
                dialogManager.dismissAll();
                bind.sessionSendChat(
                    sessionId: sessionId, text: '/agent-confirm $token');
              },
      ),
    ];
    hasOk = false;
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing Pocket-Codex...");
