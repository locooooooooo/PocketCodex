...
if(VCPKG_TARGET_IS_ANDROID AND VCPKG_TARGET_ARCHITECTURE MATCHES "^arm")
    # AOM's Android ARM assembly configure path looks for a bare `as`, which is
    # not present in the Windows NDK toolchain layout. Disable assembly for the
    # local Android smoke-test build; this keeps AV1 available without blocking
    # the first phone-to-PC connection test.
    set(aom_target_cpu "-DAOM_TARGET_CPU=generic")
endif()
